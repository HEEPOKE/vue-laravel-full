<template>
  <div
    class="w-48 bg-white rounded-lg shadow-md px-6 py-4 cursor-pointer mb-8 hover:bg-green-100 focus:outline-none focus:shadow-outline-green"
    :class="{
      'bg-green-100 shadow-outline-green': this.activePlan === this.planName,
    }"
    tabindex="0"
  ...
  >
    <div class="flex justify-between items-center mb-3">
      <h1
        class="uppercase text-base tracking-wide text-gray-700 font-bold my-2"
      >
        {{ this.planName }}
      </h1>
