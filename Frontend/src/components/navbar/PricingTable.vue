  ...
  <div>
    <table class="hidden lg:block w-full text-base">
      <thead>
        <tr>
          <th
            class="w-1/5 bg-gray-100 text-left font-normal align-top px-4 py-6 sticky top-0"
          >
          ...
          <th
            class="w-1/5 bg-gray-200 text-center border border-gray-400 font-normal px-4 py-6 sticky top-0"
          >
            ...
            <div class="mt-3">
              <a
                href="#"
                class="bg-blue-500 hover:bg-blue-700 text-white inline-block rounded w-4/5 px-4 py-3"
                >Sign Up</a
              >
            </div>
          </th>
      ...
      <div class="text-center border border-gray-400 text-base">
        ...
        <div class="odd:bg-gray-200 even:bg-white px-3 py-4">
          <div class="">
            <a
              href="#"
              class="bg-blue-500 hover:bg-blue-700 text-white inline-block rounded w-64 px-4 py-3"
              >Sign Up</a
            >
          </div>
        </div>
